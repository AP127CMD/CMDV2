...
(function () {
  ...
  const GROUPS = [
    ...
    { label: 'Progress', items: [
      ...
      { id: 'cohort-v6', label: 'AP127 Detail V6', icon: '◉' },
  ...
  function registry() {
    return {
      ...
      'cohort-v5': window.CohortViewV5,
      'cohort-v6': window.CohortViewV6,
  ...
  function App() {
    ...
    const [tweaks, setTweakState] = useState(() => ({ theme: localStorage.getItem('ap127-theme') || 'cockpit', showSim: false, showStandby: true, groupBy: 'tail' }));
